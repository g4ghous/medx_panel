    ...
    addPolicy(e) {
        ...
        if (validation == true) {
            ...
            if (this.state.name === "" ||
                ...
                axios({
                    method: 'post',
                    url: Serverurl + 'privacy-policie/create',
                    data: data,
                    headers: {
                    ...
                    .then((res) => {
                        ...
                        if (res.status === "true") {
                            ...
                            swal("Privacy Policy Succesfully Created!");
                        }
                        setTimeout(() => {
                            ...
                            <div class="parent">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <h4 class="mt-0 header-title">Create Privacy & Policy</h4>
                                    ...
                                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <h4 class="mt-0 header-title ar">رازداری اور پالیسی بنائیں</h4>
                                        ...
                                        <div class="form-group row">
                                            <div class="button-align">
                                                <button type="button" class="btn btn-danger waves-effect waves-light submit-button" onClick={this.addPolicy.bind(this)}>Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
