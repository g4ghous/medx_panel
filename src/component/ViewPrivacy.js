...
export class ViewPrivacy extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
                        ...
                        <div class="card">
                            <div class="card-body table-responsive">
                                <div className="head view-list-style">
                                    ...
                                    <h4 className="ar">رازداری اور پالیسی کی تفصیلات</h4>
                                    <ul>
                                        <div class="row">
                                            <li class="col-12">
                                    ...
                                    <div class="button-align">
                                        <a href="/component/GridPolicy" type="button" class="btn btn-danger waves-effect waves-light submit-button">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
