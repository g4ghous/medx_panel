...
export class CreateRider extends Component {
    constructor(props) {
        super(props); {
            this.state = {
                data: [],
                ...
                axios({
                    ...
                    .then((res) => {
                        ...
                        if (res.status === "true") {
                            ...
                            swal("Rider Succesfully Created!");
                        }
                        setTimeout(() => {
                            window.location.href = "/component/GridRiders"
                        }, 3000)
                            ...
                            <div class="parent">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <h4 class="mt-0 header-title">Create Rider</h4>
