...
export class GridPolicy extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    componentDidMount() {
        ...
        axios({
            method: 'get',
            url: Serverurl + 'privacy-policie/list',
            data: data,
            headers: {
    ...
    deleteBooking() {
        ...
        axios({
            method: 'DELETE',
            url: Serverurl + 'privacy-policie/remove',
            params: data,
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`,
            },
    ...
    viewPrivacy(id) {
        ...
        console.log(id)
        window.location.href = "/component/ViewPrivacy"
    }

    editPrivacy(id) {
        localStorage.setItem('Privacy', id)
        console.log(id)
        window.location.href = "/component/UpdatePrivacy"
    }
                            ...
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <div className="list-head-btn">
                                        <div className="head">
                                            <h4>List Privacy & policy</h4>
                                        </div>
                                        <div class="button-align">
                                            <a href="/component/CreatePrivacy" type="button" class="btn btn-danger waves-effect waves-light submit-button">Create Privacy & policy +</a>
                                        </div>
                                    </div>
                                    <div class="">
                            ...
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <h5 className="modal-title" id="exampleModalLabel">Privacy & Policy Delete</h5>
                                    ...
                                    <div className="modal-body">
                                        <p>
                                            <strong>
                                                You're about to delete a Privacy & Policy from this page. Are you sure?
                                            </strong>
                                        </p>
                                    </div>
