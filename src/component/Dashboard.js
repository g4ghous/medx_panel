    ...
    componentDidMount() {
        ...
        axios({
            ...
            .then((res) => {
                ...
                this.setState({
                    users_view: res.data.data.users,
                    adventures_view: res.data.data.adventures,
                    destinations_view: res.data.data.destinations,
                    months_view: res.data.data.months,
                    packages_view: res.data.data.packages,
                    deals_view: res.data.data.deals,
                    bookings_view: res.data.data.bookings,
                })
                    ...
                    /> */}
                                                ...
                                                <Card className="mb-3">
                                                    <CardHeader className="card-header-tab">
                                                        <div className="card-header-title">
                                                            <i className="header-icon fas fa-rocket icon-gradient bg-tempting-azure"> </i>
                                            Bandwidth Reports
                                    </div>
                                                            ...
                                                            <div className="widget-chart-wrapper chart-wrapper-relative">
                                                                <ResponsiveContainer height={100}>
                                                                    <LineChart data={data}
                                                                        ...
                                                                        <Line type='monotone' dataKey='pv' stroke='#3ac47d' fill="#094d64"
                                                                            strokeWidth={3} />
                                                                    </LineChart>
                                                                </ResponsiveContainer>
                                                            </div>
                                                        ...
                                                        <div className="card mb-3 widget-chart">
                                                            <div className="widget-chart-content">
                                                                <div className="icon-wrapper rounded-circle">
                                                                    ...
                                                                    <i className="fas fa-laptop text-danger" />
                                                                </div>
                                                                <div className="widget-numbers">
                                                                    5.82k
                                            </div>
                                                            ...
                                                            <div className="widget-chart-wrapper chart-wrapper-relative">
                                                                <ResponsiveContainer height={100}>
                                                                    <BarChart data={data}>
                                                                        <Bar dataKey='uv' fill='#094d64' stroke='#3f6ad8' strokeWidth={2} />
                                                                    </BarChart>
                                                                </ResponsiveContainer>
                                                            </div>
                                                        </div>
                                                ...
                                                <Row>
                                                    <Col md="6">
                                                        <div className="card mb-3 bg-arielle-smile widget-chart text-white card-border">
                                                            <div className="icon-wrapper rounded-circle">
                                                                ...
                                                                <i className="fas fa-cog icon-gradient bg-arielle-smile" />
                                                            </div>
                                                            <div className="widget-numbers">
                                                                87,4
                                        </div>
                                                    ...
                                                    <Col md="6">
                                                        <div className="card mb-3 bg-midnight-bloom widget-chart text-white card-border">
                                                            <div className="icon-wrapper rounded-circle">
                                                                <div className="icon-wrapper-bg bg-white opacity-10" />
                                                                <i className="fas fa-graduation-cap icon-gradient bg-warm-flame" />
                                                            </div>
                                                            <div className="widget-numbers">
                                                                17.2k
                                        </div>
                                                    ...
                                                    <Col md="6">
                                                        <div className="card mb-3 bg-grow-early widget-chart text-white card-border">
                                                            <div className="icon-wrapper rounded-circle">
                                                                ...
                                                                <i className="fas fa-laptop text-white" />
                                                            </div>
                                                            <div className="widget-numbers">
                                                                63.2k
                                        </div>
                                                ...
                                                <div className="card mb-3 widget-chart">
                                                    <div className="widget-chart-content">
                                                        <div className="icon-wrapper rounded-circle">
                                                            ...
                                                            <i className="fas fa-heart icon-gradient bg-premium-dark"> </i>
                                                        </div>
                                                        <div className="widget-numbers">
                                                            4517.82
                                    </div>
                                    ...
                                    <div className="btn-actions-pane-right">
                                                    ...
                                                    <div className="d-block text-center card-footer">
                                                        <button className="mr-2 btn-icon btn-icon-only btn btn-outline-danger"><i className="fas fa-trash btn-icon-wrapper"> </i></button>
                                                ...
                                                <div className="card mb-3 widget-chart">
                                                    <div className="widget-chart-content">
                                                        <div className="icon-wrapper rounded-circle">
                                                            ...
                                                            <i className="fas fa-desktop text-success" />
                                                        </div>
                                                        <div className="widget-numbers">
                                                            17.2k
                                    </div>
